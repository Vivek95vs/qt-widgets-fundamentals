...
QT_MOC_LITERAL(4, 29, 7), // "clicked"
QT_MOC_LITERAL(5, 37, 4), // "test"
QT_MOC_LITERAL(6, 42, 10) // "mouseClick"

    },
    "CustomItem\0sizeChanged\0\0size\0clicked\0"
    "test\0mouseClick"
};
...
void CustomItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sizeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->clicked(); break;
        case 2: _t->test(); break;
        case 3: _t->mouseClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomItem::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomItem::sizeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomItem::clicked)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CustomItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CustomItem.data,
    qt_meta_data_CustomItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void CustomItem::sizeChanged(int _t1)
{
