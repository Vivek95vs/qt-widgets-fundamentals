...
QT_MOC_LITERAL(1, 7, 16), // "sendMessageToQML"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "g"
QT_MOC_LITERAL(4, 27, 7), // "receive"
QT_MOC_LITERAL(5, 35, 1) // "x"

    },
    "deneme\0sendMessageToQML\0\0g\0receive\0x"
};
...
void deneme::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<deneme *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMessageToQML((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        ...
        {
            using _t = void (deneme::*)(QVariant );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&deneme::sendMessageToQML)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void deneme::sendMessageToQML(QVariant _t1)
{
