...
struct qt_meta_stringdata_TextFieldDoubleValidator_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TextFieldDoubleValidator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TextFieldDoubleValidator_t qt_meta_stringdata_TextFieldDoubleValidator = {
    {
QT_MOC_LITERAL(0, 0, 24) // "TextFieldDoubleValidator"
...
static const uint qt_meta_data_TextFieldDoubleValidator[] = {
...
QT_INIT_METAOBJECT const QMetaObject TextFieldDoubleValidator::staticMetaObject = { {
    QMetaObject::SuperData::link<QDoubleValidator::staticMetaObject>(),
    qt_meta_stringdata_TextFieldDoubleValidator.data,
    qt_meta_data_TextFieldDoubleValidator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TextFieldDoubleValidator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextFieldDoubleValidator.stringdata0))
